 ...
 * @author Rui
 */
public class BotoesNaves extends Button {

    private static AudioClip somBt;
    
    public BotoesNaves(String imagem) {
        super();
    ...
    private void preparaBackground(String imagem) {
        if(imagem.equalsIgnoreCase(BT_MILITAR)){
            setBackground(new Background(new BackgroundImage(Imagens.getImagem(BT_MILITAR),
            ...
            setBackground(new Background(new BackgroundImage(Imagens.getImagem(BT_EXPLORATORIA),
                    BackgroundRepeat.NO_REPEAT,
                    BackgroundRepeat.NO_REPEAT,
                    BackgroundPosition.CENTER,
                    new BackgroundSize(220, 140, false, false, false, false))));
